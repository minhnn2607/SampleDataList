package vn.nms.sample.presentation.utils.navigation
...
import vn.nms.sample.presentation.utils.navigation.DeeplinkNavigationPolicy.RETAIN_AND_DISCARD
import vn.nms.sample.presentation.utils.navigation.data.NavigateOnceDeeplinkRequest
import vn.nms.sample.presentation.utils.navigation.extensions.navigateDeeplink
import vn.nms.sample.presentation.utils.navigation.extensions.navigateOnce
import vn.nms.sample.presentation.utils.navigation.util.toSingleEvent
...
object DeeplinkNavigator {
    /**
     * Should be used whenever you are navigating with deeplink
...
internal class Navigator private constructor() {
    ...
    // List of fragment Ids which will not be pop from back stack when deeplink is clicked
    ...
    internal fun handleDeeplink(
        ...
        // If the BottomNavigationView is attached to activity, all the deeplink will
...
/**
 * Navigation policy for deeplink
 */
