package vn.nms.sample.presentation.utils.navigation.extensions
...
import vn.nms.sample.presentation.utils.navigation.data.NavigateOnceDirectionRequest
...
private fun createNavOptions(
    ...
    val animation = mNavAnimations
    val builder = NavOptions.Builder()
    NavOptions.Builder().setPopUpTo(popUpTo, isPopUpToInclusive)
    if (animation != null) {
        builder.setEnterAnim(defaultNavOptions?.enterAnim ?: animation.enterAnimation)
            .setExitAnim(defaultNavOptions?.exitAnim ?: animation.exitAnimation)
            .setPopEnterAnim(defaultNavOptions?.popEnterAnim ?: animation.popEnterAnimation)
            .setPopExitAnim(defaultNavOptions?.popExitAnim ?: animation.popExitAnimation)
    }
