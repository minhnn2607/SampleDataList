...
import vn.nms.sample.presentation.ui.base.adapter.BaseListAdapter
...
class MovieSingleTypeListAdapter @Inject constructor(
    @ApplicationContext context: Context,
    private val imageLoader: ImageLoader
) :
    BaseListAdapter<MovieModel, ItemMovieBinding>(
        context,
